...
#'      Example Values: true
#' @export
twtr_statuses_unretweet <- function(id, trim_user = NULL, ...) {
    twtr_api("POST", sprintf("https://api.twitter.com/1.1/statuses/unretweet/%s.json", id), body = list(trim_user = trim_user, ...))
}
