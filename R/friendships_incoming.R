...
#'
#' @seealso \url{https://dev.twitter.com/rest/reference/get/friendships/incoming}
#' @param cursor
...
#'      Example Values: true
#' @export
twtr_friendships_incoming <- function(cursor = NULL, stringify_ids = NULL, ...) {
    twtr_api("GET", "https://api.twitter.com/1.1/friendships/incoming.json", query = list(cursor = cursor, stringify_ids = stringify_ids, ...))
}
