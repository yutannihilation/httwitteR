...
#'      to +90.0 (North is positive) inclusive. It will also be ignored if there isnÅft a corresponding long
#'      parameter.
...
#' @param accuracy
#'      A hint on the ÅgregionÅh in which to search. If a number, then this is a radius in meters, but it can
...
#'      returned will equal max_results, but instead informs how many ÅgnearbyÅh results to return. Ideally,
