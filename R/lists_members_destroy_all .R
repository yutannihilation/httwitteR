...
#'
#' @seealso \url{https://dev.twitter.com/rest/reference/post/lists/members/destroy_all}
#' @param list_id
...
#' @export
twtr_lists_members_destroy_all <- function(list_id, slug, user_id = NULL, screen_name = NULL, owner_screen_name = NULL, owner_id = NULL, ...) {
    twtr_api("POST", "https://api.twitter.com/1.1/lists/members/destroy_all.json ", body = list(list_id = list_id, slug = slug, user_id = user_id, 
