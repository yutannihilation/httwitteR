...
#'
#' @seealso \url{https://dev.twitter.com/rest/reference/get/lists/subscribers/show}
...
#' @export
twtr_lists_subscribers_show <- function(owner_screen_name = NULL, owner_id = NULL, list_id, slug, user_id, screen_name, include_entities = NULL, 
    skip_status = NULL, ...) {
    twtr_api("GET", "https://api.twitter.com/1.1/lists/subscribers/show.json ", query = list(owner_screen_name = owner_screen_name, owner_id = owner_id, 
        list_id = list_id, slug = slug, user_id = user_id, screen_name = screen_name, include_entities = include_entities, skip_status = skip_status, 
        ...))
}
